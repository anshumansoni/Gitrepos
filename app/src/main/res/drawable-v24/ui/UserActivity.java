...
public class UserActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.AboutApp :
                Intent aboutApp = new Intent(this, com.prytech.gitrepo.ui.AboutApp.class);
                startActivity(aboutApp);
                return true;

            case R.id.exitApp :
                new MaterialAlertDialogBuilder(com.prytech.gitrepo.ui.UserActivity.this)
                        .setMessage("Exit App ?")
    ...
    public void startGithubActivity() {
        ...
        if(githubUserName.isEmpty())
        {
            ...
            userName.clearFocus();
            Intent githubActivity = new Intent(com.prytech.gitrepo.ui.UserActivity.this, com.prytech.gitrepo.ui.GithubActivity.class);
